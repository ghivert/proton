var electron = require('electron');(function(undefined) {
  // @note
...
/* Generated by Opal 0.10.3 */
Opal.modules["proton/ipc_renderer"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var self = $IpcRenderer = $klass($base, $super, 'IpcRenderer', $IpcRenderer);

      var def = self.$$proto, $scope = self.$$scope;

      self.ipc = electron.ipcRenderer;

      return (function(self) {
        var $scope = self.$$scope, def = self.$$proto, TMP_1, TMP_2;

        Opal.defn(self, '$send', TMP_1 = function $$send(channel) {
          var self = this;
          if (self.ipc == null) self.ipc = nil;

          return self.ipc.send(channel);
        }, TMP_1.$$arity = 1);
        return (Opal.defn(self, '$on', TMP_2 = function $$on(event) {
          var self = this, $iter = TMP_2.$$p, callback = $iter || nil;
          if (self.ipc == null) self.ipc = nil;

          TMP_2.$$p = null;
          return self.ipc.on(event, callback);
...
/* Generated by Opal 0.10.3 */
Opal.modules["proton/remote"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$==', '$[]', '$<<', '$delete', '$to_sym', '$split', '$each']);
  return (function($base) {
    var $Proton, self = $Proton = $module($base, 'Proton');
    ...
    (function($base, $super) {
      function $Remote(){};
      var self = $Remote = $klass($base, $super, 'Remote', $Remote);

      var def = self.$$proto, $scope = self.$$scope, TMP_3, TMP_4;

      self.remote = electron.remote;

      Opal.defs(self, '$access', TMP_3 = function $$access(global_value) {
        var $a, $b, TMP_1, $c, TMP_2, self = this, access = nil, values = nil, opal = nil;
        if (self.remote == null) self.remote = nil;
        ...
        if (global_value['$[]'](0)['$==']("$")) {
          ...
          ($a = ($b = values).$each, $a.$$p = (TMP_1 = function(val){var self = TMP_1.$$s || this;
if (val == null) val = nil;
          return access['$<<'](val.$to_sym())}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
        };
        opal = self.remote.require("./main.js").Opal;
        ($a = ($c = access).$each, $a.$$p = (TMP_2 = function(name){var self = TMP_2.$$s || this;
if (name == null) name = nil;
        return opal = opal[name]}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($c);
        return opal;
      }, TMP_3.$$arity = 1);

      return (Opal.defs(self, '$ready!', TMP_4 = function() {
        var self = this;
        if (self.remote == null) self.remote = nil;

        return self.remote.getGlobal("ready").ready = true;
      }, TMP_4.$$arity = 0), nil) && 'ready!';
    })($scope.base, null)
  })($scope.base)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$lambda', '$[]=', '$update_walls', '$update_graphics', '$ready!', '$on', '$[]', '$===', '$shift', '$init']);
  self.$require("opal");
  self.$require("proton/ipc_renderer");
  self.$require("proton/remote");
  (function($base, $super) {
    function $UpdateGraph(){};
    var self = $UpdateGraph = $klass($base, $super, 'UpdateGraph', $UpdateGraph);

    var def = self.$$proto, $scope = self.$$scope, TMP_2, TMP_4, TMP_6;

    self.board = document.getElementById("board");

    Opal.defs(self, '$init', TMP_2 = function $$init() {
      var $a, $b, TMP_1, self = this, init_ = nil;
      if (self.board == null) self.board = nil;

      init_ = ($a = ($b = self).$lambda, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, robots = nil;
        if (self.board == null) self.board = nil;

      robots = $hash2([], {});
        robots['$[]=']("target", self.board.getElementById("target"));
        robots['$[]=']("red", self.board.getElementById("robot-red"));
        robots['$[]=']("blue", self.board.getElementById("robot-blue"));
        robots['$[]=']("yellow", self.board.getElementById("robot-yellow"));
        robots['$[]=']("green", self.board.getElementById("robot-green"));
        robots['$[]=']("black", self.board.getElementById("robot-black"));
        self.$update_walls();
        self.$update_graphics(robots);
        return (($scope.get('Proton')).$$scope.get('Remote'))['$ready!']();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
      return self.board.addEventListener("load", init_, false);
    }, TMP_2.$$arity = 0);

    Opal.defs(self, '$update_graphics', TMP_4 = function $$update_graphics(robots) {
      var $a, $b, TMP_3, self = this;

      return ($a = ($b = (($scope.get('Proton')).$$scope.get('IpcRenderer'))).$on, $a.$$p = (TMP_3 = function(event, message){var self = TMP_3.$$s || this, $case = nil;
if (event == null) event = nil;if (message == null) message = nil;
      console.log('la');
        ...
        return (function() {$case = message['$[]'](10);if ("B"['$===']($case)) {return robots['$[]']("target").setAttributeNS(null, "fill", "blue");}else if ("R"['$===']($case)) {return robots['$[]']("target").setAttributeNS(null, "fill", "red");}else if ("V"['$===']($case)) {return robots['$[]']("target").setAttributeNS(null, "fill", "green");}else if ("J"['$===']($case)) {return robots['$[]']("target").setAttributeNS(null, "fill", "yellow");}else { return nil }})();}, TMP_3.$$s = self, TMP_3.$$arity = 2, TMP_3), $a).call($b, "update-graphics");
    }, TMP_4.$$arity = 1);

    return (Opal.defs(self, '$update_walls', TMP_6 = function $$update_walls() {
      var $a, $b, TMP_5, self = this;

      return ($a = ($b = (($scope.get('Proton')).$$scope.get('IpcRenderer'))).$on, $a.$$p = (TMP_5 = function(event, message){var self = TMP_5.$$s || this, line = nil;
        if (self.board == null) self.board = nil;
if (event == null) event = nil;if (message == null) message = nil;
      message = message.$shift();
        ...
        return self.board.appendChild(line);}, TMP_5.$$s = self, TMP_5.$$arity = 2, TMP_5), $a).call($b, "update-walls");
    }, TMP_6.$$arity = 0), nil) && 'update_walls';
  })($scope.base, null);
  return $scope.get('UpdateGraph').$init();
})(Opal);
